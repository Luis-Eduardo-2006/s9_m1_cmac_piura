...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', background: '#F5F7FA' }}>
      ...
      {/* Header */}
      <nav style={{ background: '#004A9F', padding: '1rem 2rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <img
          src="https://images.seeklogo.com/logo-png/29/1/caja-piura-logo-png_seeklogo-299545.png"
          alt="Caja Piura"
          style={{ height: '38px', objectFit: 'contain', cursor: 'pointer', filter: 'brightness(0) invert(1)' }}
          onClick={() => navigate('/')}
        />
      ...
      <div style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem' }}>
        <div style={{ background: '#fff', borderRadius: '16px', width: '100%', maxWidth: '420px', boxShadow: '0 8px 32px rgba(0,74,159,0.12)', overflow: 'hidden' }}>
          ...
          {/* Encabezado del card */}
          <div style={{ background: 'linear-gradient(135deg, #003580, #004A9F)', padding: '2rem', textAlign: 'center', color: '#fff' }}>
            <img
              src="https://images.seeklogo.com/logo-png/29/1/caja-piura-logo-png_seeklogo-299545.png"
              alt="Caja Piura"
              style={{ height: '36px', objectFit: 'contain', filter: 'brightness(0) invert(1)', marginBottom: '1rem' }}
            />
          ...
          <form onSubmit={handleSubmit} style={{ padding: '2rem' }}>
            ...
            <div style={{ marginBottom: '1.2rem' }}>
              ...
              <input
                ...
                style={{ display: 'block', width: '100%', padding: '0.75rem 1rem', border: '1.5px solid #E0E6EF', borderRadius: '8px', fontSize: '0.95rem', outline: 'none', transition: 'border-color 0.2s' }}
            ...
            <div style={{ marginBottom: '1.5rem' }}>
              ...
              <div style={{ position: 'relative' }}>
                <input
                  ...
                  placeholder="••••••••"
                  style={{ display: 'block', width: '100%', padding: '0.75rem 2.8rem 0.75rem 1rem', border: '1.5px solid #E0E6EF', borderRadius: '8px', fontSize: '0.95rem', outline: 'none', transition: 'border-color 0.2s' }}
                  onFocus={e => e.target.style.borderColor = '#004A9F'}
                  onBlur={e => e.target.style.borderColor = '#E0E6EF'}
                />
                <i
                  ...
                  style={{ position: 'absolute', right: '1rem', top: '50%', transform: 'translateY(-50%)', color: '#aaa', cursor: 'pointer' }}
                />
              </div>
            </div>
            ...
            {error && (
              <div style={{ background: '#FFF0F0', border: '1px solid #FFB3B3', borderRadius: '8px', padding: '0.7rem 1rem', marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <i className="fa-solid fa-circle-xmark" style={{ color: '#e74c3c' }} />
            ...
            {exito && (
              <div style={{ background: '#F0FFF4', border: '1px solid #B7E4C7', borderRadius: '8px', padding: '0.7rem 1rem', marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                <i className="fa-solid fa-circle-check" style={{ color: '#27ae60' }} />
            ...
            <button
              ...
              disabled={cargando}
              style={{ width: '100%', padding: '0.85rem', fontSize: '1rem', borderRadius: '8px', justifyContent: 'center', opacity: cargando ? 0.75 : 1 }}
            >
              {cargando
          ...
          <div style={{ background: '#F5F7FA', borderTop: '1px solid #E0E6EF', padding: '0.8rem 2rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem' }}>
